...
async def run():
    async with async_playwright() as p:
        ...
        await page.screenshot(path=os.path.join(artifacts_dir, "mobile_app_topbar.png"))
        print("Captured mobile_app_topbar.png")
        ...
        await page.screenshot(path=os.path.join(artifacts_dir, "mobile_app_sidebar_drawer.png"))
        print("Captured mobile_app_sidebar_drawer.png")
