...
def run_warmup_cycle():
    ...
    Cycle:
      1. Fetch all active warmup-enabled accounts.
      2. Each account checks its inbox and replies to any pending warmup emails.
      3. Then, probabilistically, each account sends a fresh warmup email to another.
    """
