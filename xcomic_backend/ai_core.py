...
def chat_with_assistant(message: str, history: list = None, user=None) -> str:
    try:
        system_prompt = (
            ...
            "CRITICAL LANGUAGE RULE: You are highly multilingual. If the user writes in a regional language or uses phonetic spelling (e.g., Banglish, Hinglish, Pinyin), you MUST seamlessly understand their intent and reply in that exact same language and phonetic style naturally.\n"
        )
