...
function upgradeToCustomTZPicker(selectId) {
    ...
    dropdownMenu.style.cssText = 'display:none; position:absolute; bottom:calc(100% + 6px); left:0; right:0; background:var(--card, #fff); border:2px solid var(--border, #e2e8f0); border-radius:14px; z-index:99999; box-shadow:0 20px 60px rgba(0,0,0,0.15); overflow:hidden;';
...
function showToast(message, type) {
    ...
    toast.style.top = "20px"; toast.style.bottom = "auto";
    ...
    window._toastTimer = setTimeout(function() {
        ...
        setTimeout(function() { toast.style.top = "20px"; toast.style.bottom = "auto"; }, 300);
...
window.saveSchedule = async function() {
    ...
    if (!window.currentCampaignId) {
        ...
        try {
            ...
            console.error('Save Schedule Error:', e); showToast('Error: ' + e.message, 'error');
...
function populateTimezones() {
    ...
    try {
        ...
        // Automatically upgrade all timezones to the Perfect Custom UI!
