...
print('Triggering aggressive kill via API...')
try:
    with urllib.request.urlopen('https://xcomic.xyz/', timeout=10) as f:
...
# Restore original passenger_wsgi
original_wsgi = '''
import os
import sys
...
'''
ftp.storbinary('STOR passenger_wsgi.py', io.BytesIO(original_wsgi.encode('utf-8')))
print('Restored passenger_wsgi.py')
