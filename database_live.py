...
if DATABASE_URL.startswith("sqlite"):
    ...
    # Set synchronous pragma dynamically on connect instead of at module import time
...
if __name__ == "__main__":
    ...
    try:
        with engine.connect() as conn:
            ...
            print("[Setup] SQLite WAL mode enabled successfully.")
    except Exception as e:
        print(f"[Setup] Failed to enable WAL: {e}")
